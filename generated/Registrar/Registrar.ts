...
export class AngelProtocolParamsChanged__Params {
  ...
  get _newAngelProtocolParams(): AngelProtocolParamsChanged_newAngelProtocolParamsStruct {
    return changetype<AngelProtocolParamsChanged_newAngelProtocolParamsStruct>(
      this._event.parameters[0].value.toTuple()
    );
  }
}

export class AngelProtocolParamsChanged_newAngelProtocolParamsStruct extends ethereum.Tuple {
...
export class RebalanceParamsChanged__Params {
  ...
  get _newRebalanceParams(): RebalanceParamsChanged_newRebalanceParamsStruct {
    return changetype<RebalanceParamsChanged_newRebalanceParamsStruct>(
      this._event.parameters[0].value.toTuple()
    );
  }
}

export class RebalanceParamsChanged_newRebalanceParamsStruct extends ethereum.Tuple {
...
export class UpdateRegistrarConfigDetailsStruct extends ethereum.Tuple {
  ...
  get splitToLiquid(): UpdateRegistrarConfigDetailsSplitToLiquidStruct {
    return changetype<UpdateRegistrarConfigDetailsSplitToLiquidStruct>(
      this[13].toTuple()
    );
  }
...
export class UpdateRegistrarConfigDetailsSplitToLiquidStruct extends ethereum.Tuple {
  get max(): BigInt {
...
export class Registrar extends ethereum.SmartContract {
  ...
  queryConfig(): Registrar__queryConfigResultValue0Struct {
    let result = super.call(
      "queryConfig",
      "queryConfig():((address,address,address,address,address,address,address,address,address,address,address,address,address,(uint256,uint256,uint256),address,address,address,uint256,address,address,address,address,address,address,address,address,address,address,address))",
      []
    );
