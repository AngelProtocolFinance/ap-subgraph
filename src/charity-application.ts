...
export function handleInitilizedCharityApplication(
  ...
  entity.updatedConfig_proposalExpiry =
    event.params.updatedConfig.proposalExpiry
  entity.updatedConfig_applicationMultisig =
    event.params.updatedConfig.applicationMultisig
  entity.updatedConfig_accountsContract =
    event.params.updatedConfig.accountsContract
  entity.updatedConfig_seedSplitToLiquid =
    event.params.updatedConfig.seedSplitToLiquid
  entity.updatedConfig_newEndowGasMoney =
    event.params.updatedConfig.newEndowGasMoney
  entity.updatedConfig_gasAmount = event.params.updatedConfig.gasAmount
  entity.updatedConfig_fundSeedAsset = event.params.updatedConfig.fundSeedAsset
  entity.updatedConfig_seedAsset = event.params.updatedConfig.seedAsset
  entity.updatedConfig_seedAssetAmount =
    event.params.updatedConfig.seedAssetAmount
