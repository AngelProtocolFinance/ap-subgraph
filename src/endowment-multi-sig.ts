...
export function handleSubmission(event: SubmissionEvent): void {
  ...
  entity.transactionId = event.params.transactionId
  entity.transaction_title = event.params.transaction.title
  entity.transaction_description = event.params.transaction.description
  entity.transaction_destination = event.params.transaction.destination
  entity.transaction_value = event.params.transaction.value
  entity.transaction_data = event.params.transaction.data
  entity.transaction_executed = event.params.transaction.executed
  entity.transaction_metadata = event.params.transaction.metadata
