...
export class EndowmentMultiSigWalletFactory extends ethereum.SmartContract {
  static bind(address: Address): EndowmentMultiSigWalletFactory {
    return new EndowmentMultiSigWalletFactory(
      "EndowmentMultiSigWalletFactory",
      address
    );
  }
